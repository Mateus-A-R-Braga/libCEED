...
PetscErrorCode CreateStatsOperator(instance_of_ProblemQFunctionSpec, ceed_data, ...........){
// setup restriction
// setup basis
// create operator
  ...
  CeedQFunctionContextDestroy(&instance_of_ProblemQFunctionSpec.qfunction_context);
  CeedQFunctionAddOutput(qf_stats, "U_prod", num_comp_stats, CEED_EVAL_INTERP); // This sets the Qfunction input
  CeedBasisCreateTensorH1Lagrange(ceed, dim, num_comp_stats, P, Q, CEED_GAUSS, &basis_stats); //This creates the basis


// finish adding qfunciton inputs and outputs
