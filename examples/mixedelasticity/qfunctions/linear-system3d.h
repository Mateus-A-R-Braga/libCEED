...
/// @file
/// Linear mixed-elasticity problem 3D (hex element) using PETSc

#ifndef LINEAR_SYSTEM3D_H
#define LINEAR_SYSTEM3D_H
...
// -----------------------------------------------------------------------------
CEED_QFUNCTION(LinearSystem3D)(void *ctx, CeedInt Q,
...
// -----------------------------------------------------------------------------
CEED_QFUNCTION(JacobianLinearSystem3D)(void *ctx, CeedInt Q,
                                       const CeedScalar *const *in,
                                       CeedScalar *const *out) {
  // *INDENT-OFF*
  // Inputs
...
#endif //End of LINEAR_SYSTEM3D_H
