...
/// @file
/// Force of linear mixed-elasticity problem 3D (hex element) using PETSc

#ifndef LINEAR_FORCE3D_H
#define LINEAR_FORCE3D_H
...
// -----------------------------------------------------------------------------
CEED_QFUNCTION(LinearForce3D)(void *ctx, const CeedInt Q,
